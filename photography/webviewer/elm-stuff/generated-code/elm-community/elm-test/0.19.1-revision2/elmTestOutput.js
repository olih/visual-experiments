...
var $author$project$GroupInfo$Model = F2(
	function (tags, items) {
		return {items: items, tags: tags};
	});
var $author$project$MediaFileInfo$Model = F3(
	function (item, folder, tags) {
		return {folder: folder, item: item, tags: tags};
	});
var $author$project$MediaFileInfo$decoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$MediaFileInfo$Model,
	...
	A2(
		...
		'tags',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$GroupInfo$decoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$GroupInfo$Model,
	A2(
		$elm$json$Json$Decode$field,
		'tags',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)),
	A2(
		$elm$json$Json$Decode$field,
		'items',
		$elm$json$Json$Decode$list($author$project$MediaFileInfo$decoder)));
...
var $author$project$Fuzzing$exGroupInfo = '\n{\n  "tags": [\n    "London",\n    "2017",\n    "2018"\n  ],\n  "items": [\n    {\n      "item": "image1.jpg",\n      "folder": "folder1",\n      "tags": [\n        "2018",\n        "London"\n      ]\n    },\n    {\n      "item": "image2.jpg",\n      "folder": "folder1",\n      "tags": [\n        "2017",\n        "London"\n      ]\n    },\n    {\n      "item": "image3.jpg",\n      "folder": "folder3",\n      "tags": [\n        "2017",\n        "Paris"\n      ]\n    },\n    {\n      "item": "image4.jpg",\n      "folder": "folder3",\n      "tags": [\n      ]\n    }\n    ]\n}\n';
var $author$project$GroupInfoTest$expected = {
	folder: 'folder1',
	item: 'image1.jpg',
...
var $author$project$GroupInfoTest$suite = A2(
	$elm_explorations$test$Test$describe,
	'MediaFileInfo Module',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					function (_v0) {
						return A2(
							...
							$elm$core$Maybe$Just($author$project$GroupInfoTest$expected),
							$elm$core$List$head(
								A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									A2(
										...
										$elm$core$Result$toMaybe(
											A2(
												$elm$core$Debug$log,
												'parsing',
												A2($elm$json$Json$Decode$decodeString, $author$project$GroupInfo$decoder, $author$project$Fuzzing$exGroupInfo)))))));
					})
				]))
		]));
var $author$project$Test$Generated$Main1336543207$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/olivier/Documents/github/visual-experiments/photography/webviewer/tests/Fuzzing.elm', '/Users/olivier/Documents/github/visual-experiments/photography/webviewer/tests/GroupInfoTest.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 355556966380400
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'GroupInfoTest',
				_List_fromArray(
					[$author$project$GroupInfoTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main1336543207':{'init':$author$project$Test$Generated$Main1336543207$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8075.sock";
