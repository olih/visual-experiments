...
do python create-circle-stake.py --radius "1/4 1/4 0/1 1/1" --angle "1/1 1/$angle 1/1" --width 10
done
...
do
    ...
    do  python create-circle-stake.py --radius "1/4 1/52 -1/$radius 1/1" --angle "$angle/1 1/20 1/1" --width 10
done
done
